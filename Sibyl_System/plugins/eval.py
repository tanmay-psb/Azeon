...
@System.on(system_cmd(pattern=r"azeon (exec|xecute|x|ex)"))
async def run(event):
...
@System.on(system_cmd(pattern=r"azeon (ev|eva|eval|py)"))
...
EXAMPLE - `!azeon x print("OWO")`
Run code using **eval**
CMD - <ev or eva or eval or py> your code
EXAMPLE - `!azeon eval 1 + 1`
"""
